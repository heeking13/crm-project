...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="21c0830c56ad46eb920896c36dca22f1">
				<input type="text" class="form-control" id="create-activityName" value="五彩城营销策略和技法探究">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="01ba30338d624c0fa8abeae633d66486">
				<input type="text" class="form-control" id="create-contactsName" value="贺庆">
			</div>
		</div>
