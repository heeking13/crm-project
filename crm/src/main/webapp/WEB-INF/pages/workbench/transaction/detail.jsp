...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${tran.name} <small>￥${tran.money}万元</small></h3>
		</div>
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<c:forEach items="${tranRemarkList}" var="obj">
			<div class="remarkDiv" style="height: 60px;">
				<img title="${obj.createBy}" src="image/user-thumbnail.png" style="width: 30px; height:30px;">
				<div style="position: relative; top: -40px; left: 40px;" >
					<h5>${obj.noteContent}</h5>
					<font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;">${obj.editFlag=='0'?obj.createTime:obj.editTime} 由 ${obj.editFlag=='0'?obj.createBy:obj.editBy}${obj.editFlag=='0'?'创建':'修改'}</small>
		...
		<div style="position: relative; top: 100px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable" class="table table-hover" style="width: 900px;">
					...
					<tbody>
						<c:forEach items="${tranHistoryList}" var="obj">
							<tr>
								<td>${obj.stage}</td>
								<td>${obj.money}</td>
